...
public protocol GymfileProtocol: AnyObject {
    ...
    /// Method used to export the archive. Valid values are: app-store-connect, validation, release-testing, package, enterprise, development, developer-id and mac-application
